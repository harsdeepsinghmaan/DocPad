...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UHNBGMController/UHNBGMController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UHNBLEController/UHNBLEController.framework"
fi
