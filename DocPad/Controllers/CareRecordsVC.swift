...
class CareRecordsVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
 ...
 @IBOutlet weak var heightOfNavigationbar: NSLayoutConstraint!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CareRecordsCell") as! CareRecordsCell
        return cell
    }
