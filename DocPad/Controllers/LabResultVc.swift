...
class LabResultVc: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableVw.dequeueReusableCell(withIdentifier: "labCell") as! LabResultTvc
        
        if indexPath.row == 0{
            cell.lblName.text = "BloodTest"
        }else{
            cell.lblName.text = ""
        }
        return cell
