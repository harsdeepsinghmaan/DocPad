...
class ProcedureVc: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableVw.dequeueReusableCell(withIdentifier: "procedureCell") as! ProcedureTvc
        
        if indexPath.row == 0{
            cell.lblName.text = "Knee Surgery"
        }
        else{
            cell.lblName.text = "Knee Surgery"
        }
