...
//    var total3Reverse  = NSMutableArray()
    ...
    override func viewDidLoad() {
        ...
        getWeight_LineChart()
//        let recovedUserJsonData = UserDefaults.standard.object(forKey: "WeightDict")
//
...
//
//
//            weightIntVal = dict1.value(forKey: "weight") as! Int
//
...
//            }
//
////            lblWeight.text = String(weightIntVal)
...
//            weightIntVal1 = dict2.value(forKey: "weight") as! Int
//
//            lblWeight.text = String(weightIntVal1)
//
                        ...
                        if let array = json  as? NSArray {
                            DispatchQueue.main.async {
                                ...
                                for i in 0..<self.weightArray.count{
                                    ...
                                    var dict1 = NSDictionary ()
                                    dict1 = self.weightArray.object(at: i) as! NSDictionary
                                    if ((dict1.value(forKey: "weight") as? Int) != nil) {
                                        self.weightIntVal = (dict1.value(forKey: "weight") as! Int)
                                    }
                                    else {
                                        self.weightIntVal = Int(dict1.value(forKey: "weight") as! NSNumber)
                                    }
                                    ...
                                    dateString = dateFormatter.string(from: exactDate)
                                    print(dateString)
                                    if i == self.weightArray.count - 1{
                                        self.lblWeight.text = String(self.weightIntVal)
                                    ...
                                    self.total .add(self.weightIntVal)
                                ...
                                let line1 = LineChartDataSet(entries: self.lineChartEntry,label : "weight in kg")
